...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("strThirdPartyTxUrls")) {
        if(fTestNet)
            ...
            settings.setValue("strThirdPartyTxUrls", "http://explorer.coinline.org/tx/%s");
    }
    strThirdPartyTxUrls = settings.value("strThirdPartyTxUrls", "http://explorer.coinline.org/tx/%s").toString();
