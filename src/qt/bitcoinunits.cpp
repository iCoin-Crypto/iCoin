...
QString BitcoinUnits::name(int unit)
{
    ...
    case mBTC: return QString("mINT");
    case uBTC: return QString::fromUtf8("μINT");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("iCoins"));
    case mBTC: return QString(QObject::tr("Milli-iCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-iCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
