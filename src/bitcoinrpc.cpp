...
{
    return GetBoolArg("-testnet", false) ? 52144 : 42144;
}
...
Value stop(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "Stop iCoin server (and possibly override the detachdb config value).");
