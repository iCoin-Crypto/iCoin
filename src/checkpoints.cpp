...
namespace Checkpoints
{
    ...
    static MapCheckpoints mapCheckpoints =
        ...
        ( 0,     std::make_pair(hashGenesisBlock, 1421342237) )
        ( 400, std::make_pair(uint256("0x00000b0f948241ed2690ed15e33b6019a65ab11a1b165e4c8ce3c11952cb643d"), 1422878444) )
    ;

    // TestNet has no checkpoints
    static MapCheckpoints mapCheckpointsTestnet =
        boost::assign::map_list_of
        ( 0, std::make_pair(hashGenesisBlockTestNet, 1421342237) )
        ;
